...
const Overview = React.forwardRef(
	({ scrollToDistribution, scrollToParameters, scrollToOwnership, scrollToStabilizer, isMobile }, ref) => {
		const charts = (
			<div className="box">
				...
				<div className="container block is-fluid ">
					<div className={isMobile ? 'content box' : 'content box is-medium'}>
						<p>
							...
							governance token , in-order to make Debase achieve it's programmable target price of 1{' '}
							<a href={etherScanAddress + contractAddress.DAI}>DAI</a>. While distributing 100% of both
							the tokens using staking and stabilizer pools to promote fairness and decentralization.
						</p>
						<p>
						...
						<p>
							...
							<a href="https://compound.finance/docs/governance">Compound Finance</a> to allow
							manipulation of various {/* eslint-disable-next-line */}
							<a onClick={() => scrollToParameters()}>parameters</a> related to governance, distribution
							and most importantly the supply adjustment parameters. So the community can get together to
							completely control the behaviour of the protocol in-order to help Debase it's target price.
						</p>
					</div>
					{charts}
				</div>
