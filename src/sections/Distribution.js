				...
				<div className="container block is-fluid">
					<div className="box content ">
						...
						<p>
							...
							<a href="https://app.uniswap.org/#/usdc">USDC</a> tokens into the{' '}
							<Link to="/dapp/staking/debase-dai">DEGOV/USDC</Link> pool.A total of 25,000 DEGOV tokens
							...
							<strong>
								So if you encounter an error while staking, be sure that you are staking under the
								mentioned limit or the first rebase has been initiated and the DEGOV/USDC pool started.
							</strong>
						</p>
					</div>
				</div>
