...
// export default function EthDebase() {
...
// 	const { data: rewardPerTokenMax, mutate: getRewardPerTokenMax } = useSWR(
// 		[ contractAddress.sp3Pool, 'rewardPerTokenMax' ],
// 		{
// 			fetcher: fetcher(library, V3Abi)
// 		}
// 	);

// 	const { data: tokenSupply, mutate: getTokenSupply } = useSWR([ contractAddress.debaseKovan, 'totalSupply' ], {
...
// 			label: 'Max Earnable',
// 			value:
// 				rewardPerTokenMax && tokenSupply
// 					? parseFloat(formatEther(rewardPerTokenMax.mul(tokenSupply).div(parseEther('1'))))
// 					: '...',
// 			toolTip: 'Current pool rewards available'
// 		}
// 	];
...
// 				getRewardPerTokenMax(undefined, true);
...
// 			};
// 		},
// 		[ library, getBlockNumber, getCycleEnds, getRewardPerTokenMax, getTokenSupply, getRewardShare ]
// 	);
...
// 					<h3 className="title is-size-4-tablet is-size-5-mobile is-family-secondary">SP1 V3 Eth/Debase</h3>
...
// 							tokenText="Eth-lp"
// 							rewardText="Debase"
// 							poolName="Debase/Eth-lp"
// 							unit={18}
// 							rewardTokenImage={debase}
// 							stakeTokenImage={empty}
// 							percents={true}
// 							stakeTokenAddress={contractAddress.daiKovan}
// 							rewardTokenAddress={contractAddress.debaseKovan}
