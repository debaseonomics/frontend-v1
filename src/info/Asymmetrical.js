			...
			<div className=" block  ">
				<div className={isMobile ? 'box content' : 'box content is-medium'}>
					...
					<p>
						...
						for the price difference from the target price, and governance has configured a lag parameter of
						20 to be applied for the supply change range of 500-1500. Here, the supply increase will dampen
						by a factor of 20 and to reduce the supply increase to 50 Debase only. Thus a dramatic increase
						in supply will not be seen.
					</p>
					<p>
						On the other hand, if 10000 DEBASE tokens are to be added in rebase, a lower lag parameter of 5
						can be used to lessen the smoothing effect on the supply change. In theory, this enforces a more
						dramatic supply change (and presumably, price change) relative to the previous example.
					</p>
				</div>
			</div>
		</div>
